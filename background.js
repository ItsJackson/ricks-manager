...
const newPageLoad = async () => {
    ...
    for (let i = 0; i < inputsLength; i++) {
        ...
        if(pagePassword !== undefined) {
            ...
            popupDiv.style.backgroundColor = "#87ceeb";
            popupDiv.style.width = "250px";
            popupDiv.style.height = "120px";
            popupDiv.style.padding = "10px";
            popupDiv.style.borderRadius = "5px";
            popupDiv.style.border = "solid 1px white";

            const title = document.createElement("p")
            title.innerText = "Enter a password to save for this page.";
            ...
            goAwayButton.innerText = "Remove popup.";
